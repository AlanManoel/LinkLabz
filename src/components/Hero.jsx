...
export const Hero = () => {
    return (
        <div className="flex flex-col h-[calc(100vh-88px)] justify-center items-center md:gap-4 text-center px-8 max-sm:px-6 max-sm:gap-6 max-[775px]:gap-6">
            
            <h3 className="color-black-4 max-sm:text-2xl">SOLUÇÕES WEB E MOBILE SOB MEDIDA</h3>
            <img className="max-sm:px-6 " src="img/logo-light.png" alt="imagem da logo branco" />
